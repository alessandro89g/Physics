...
namespace Physics {
    ...
    public:
        ...
        PhysicsQuantity operator*(const T& other) const {
        ...
        PhysicsQuantity operator*(const Unit& other) const {
            ...
            return PhysicsQuantity(_value, new_units);
        }

        PhysicsQuantity operator/(const Unit& other) const {
            std::vector<Unit> new_units = _units;
            new_units.erase(std::remove(new_units.begin(), new_units.end(), other), new_units.end());
            return PhysicsQuantity(_value, new_units);
        }
